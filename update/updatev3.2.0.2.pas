...
// MyStream:=TMemoryStream.Create;
      ...
      //  try
               // h.get('http://onionhacker.github.io/test.ini',MyStream);
      //  except
              //  showmessage('网络出错!');
              //  MyStream.Free;
              //  exit;
      ...
      //  MyStream.SaveToFile(path+'\ServerVerson.ini');
       // MyStream.Free;
//====================================================== 下载版本信息
 b:=path+'\ServerVerson.ini';

DownLoadURL := TDownLoadURL.Create(self);
with DownLoadURL do
begin
FileName := b;
URL := 'https://raw.github.com/onionhacker/bananaproxy/4.0/version.ini';
...
LocalNum:=strtoint(StrIni);
//memo2.Text:=Copy(hacker,1,g-1);
ServerNum:=strtoint(StrInfor);
